...
namespace chickko.api.Migrations
{
    ...
    [Migration("20260619044535_AddBankAndWageCostToUser")]
    partial class AddBankAndWageCostToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("chickko.api.Dtos.Event.EventRollingResult", b =>
                {
                    b.Property<int>("RollingResultId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("RollingResultId"));
                    ...
                    b.Property<string>("OrderFirstStoreID")
                        .HasColumnType("text");

                    b.Property<int>("RewardID")
                        .HasColumnType("integer");

                    b.HasKey("RollingResultId");

                    b.HasIndex("RewardID");

                    b.ToTable("EventRollingResults");
                });

            modelBuilder.Entity("chickko.api.Dtos.Event.EventRollingReward", b =>
                {
                    b.Property<int>("RollingRewardId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("RollingRewardId"));
                    ...
                    b.HasKey("RollingRewardId");

                    b.ToTable("EventRollingRewards");
                });
            ...
            modelBuilder.Entity("chickko.api.Models.Cost", b =>
                {
                    ...
                    b.Property<int?>("CostPurchaseTypeID")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CostPurchaseTypeID");

                    b.HasIndex("CostStatusID");
            ...
            modelBuilder.Entity("chickko.api.Models.CostPurchaseType", b =>
                {
                    b.Property<int>("CostPurchaseTypeID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("CostPurchaseTypeID"));

                    b.Property<string>("CostPurchaseTypeName")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasKey("CostPurchaseTypeID");

                    b.ToTable("CostPurchaseType");
                });

            modelBuilder.Entity("chickko.api.Models.CostStatus", b =>
                {
                    b.Property<int>("CostStatusID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("CostStatusID"));

                    b.Property<string>("CostStatusName")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasKey("CostStatusID");

                    b.ToTable("CostStatus");
                });

            modelBuilder.Entity("chickko.api.Models.Delivery", b =>
                {
                    ...
                    b.Property<decimal>("GPAmount")
                        .HasColumnType("numeric");

                    b.Property<decimal>("GPPercent")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("chickko.api.Models.Income", b =>
                {
                    ...
                    b.Property<TimeOnly>("IncomeTime")
                        .HasColumnType("time without time zone");
            ...
            modelBuilder.Entity("chickko.api.Models.IncomeType", b =>
                {
                    b.Property<int>("IncomeTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("chickko.api.Models.OrderHeader", b =>
                {
                    ...
                    b.Property<decimal>("TotalGrabPrice")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("chickko.api.Models.Statement", b =>
                {
                    ...
                    b.Property<TimeOnly>("StatementTime")
                        .HasColumnType("time without time zone");

                    b.Property<decimal>("StatementValue")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("chickko.api.Models.StockLog", b =>
                {
                    ...
                    b.Property<DateOnly?>("StockCountDate")
                        .HasColumnType("date");

                    b.Property<TimeOnly?>("StockCountTime")
                        .HasColumnType("time without time zone");
            ...
            modelBuilder.Entity("chickko.api.Models.User", b =>
                {
                    ...
                    b.Property<int>("UserPermistionID")
                        .HasColumnType("integer");
                    ...
                    b.Property<double>("WageCost")
                        .HasColumnType("double precision");

                    b.HasKey("UserId");

                    b.HasIndex("UserPermistionID");

                    b.ToTable("Users");
                });

            modelBuilder.Entity("chickko.api.Models.UserPermistion", b =>
                {
                    b.Property<int>("UserPermistionID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("UserPermistionID"));

                    b.Property<string>("Description")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("UserPermistionName")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("chickko.api.Models.baseBank", b =>
                {
                    b.Property<int>("BankID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("chickko.api.Dtos.Event.EventRollingResult", b =>
                {
                    b.HasOne("chickko.api.Dtos.Event.EventRollingReward", "Reward")
                        .WithMany()
            ...
            modelBuilder.Entity("chickko.api.Models.Cost", b =>
                {
                    ...
                    b.HasOne("chickko.api.Models.CostPurchaseType", "CostPurchaseType")
                        .WithMany()
                        .HasForeignKey("CostPurchaseTypeID");

                    b.HasOne("chickko.api.Models.CostStatus", "CostStatus")
                        .WithMany()
                        .HasForeignKey("CostStatusID");

                    b.Navigation("CostCategory");

                    b.Navigation("CostPurchaseType");
            ...
            modelBuilder.Entity("chickko.api.Models.User", b =>
                {
                    b.HasOne("chickko.api.Models.UserPermistion", "UserPermistion")
                        .WithMany()
                        .HasForeignKey("UserPermistionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
